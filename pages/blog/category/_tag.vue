      ...
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: `'Усі публікації в блогах класифікуються як ${this.category} - Детейлінг студія Virus - комплексний догляд за Вашим авто. Передпродажна підготовка, хімчистка салону, полірування кузова, керамічне покритя, перетяжка руля, реставрація шкіри'`.slice(
            0,
            320
          )
        }
